...
if __name__=='__main__':
    ...
    dirpath = r"C:\Users\sugyan\Documents\MembraneMDfiles\charmm_gui_iapp_nanodisc\iappdimer_integral\step6.2_output"
    pdbfile = "step6.2_equilibration.pdb"
    ...
    # generate_pdb_models_with_distance_cutoff(23.5, ['PROA', 'PROB'], 'MEMB', dist_list, res_num, mod, dirpath)

    generate_models_with_increasing_distance_num_lipids(11, ['PROA', 'PROB'], 'MEMB', dist_list, res_num, mod, dirpath)
